...
def get_keystream(length): # функция изменения регистров
	...
	while i < length:
		...
		if r4_temp[10] == majority: # если бит синхронизации совпадает с мажором, то меняем регистр
		...
		if r4_temp[3] == majority: # если бит синхронизации совпадает с мажором, то меняем регистр
		...
		if r4_temp[7] == majority: # если бит синхронизации совпадает с мажором, то меняем регистр
...
print(cryp_text)
decryp_text = dec_a5_2(cryp_text)
print("Расшифрованно(A5/2)")
print(decryp_text)
